...
const items = [
    {label: "Pocetna", link: "/"},
    {label: "Transakcije", link: "/transactions"},
    {label: "Podesavanja", link: "/manage"},
]

function MobileNavbar(){
    const [isOpen, setIsOpen] = useState(false);

    return <div className="block border-separate bg-background
    md:hidden">
...
function NavbarItem({link, label, clickCallback} : {
    ...
    return (
        <div className="relative flex items-center">
            ...
            onClick={() => {
                if (clickCallback) onclickCallbackClick();
            }}
            >
                {label}
            </Link>
