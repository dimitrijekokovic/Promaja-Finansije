...
const columns: ColumnDef<TransactionHistoryRow>[] = [
...

  {
    ...
    cell: ({ row }) => (
      <div
        className={cn(
          "inline-flex min-w-[80px] justify-center rounded-md px-2 py-1 text-xs font-medium capitalize",
          row.original.type === "prihod" &&
            "bg-emerald-400/10 text-emerald-500",
          row.original.type === "rashod" && "bg-red-400/10 text-red-500"
        )}
      >
        {row.original.type}
      </div>
...

  {
    ...
    cell: ({ row }) => (
      <p className="inline-flex min-w-[110px] justify-center rounded-md bg-gray-400/5 px-3 py-1 text-sm font-medium">
